...
def load_dataset():
    ...
    test_set_x_orig = np.array(train_dataset["X_train"][2561:2813])  # train set features
    test_set_y_orig = np.array(train_dataset["Y_train"][2561:2813])  # train set features
